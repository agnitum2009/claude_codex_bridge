...
| [native-cli-providers](plans/native-cli-providers/README.md) | In progress | Add first-class native CLI providers and provider ask-skill projection for Kimi Code, Deep Code, OpenCode, AGY, and MiMo Code. |
